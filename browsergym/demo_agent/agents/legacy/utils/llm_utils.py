...
def get_tokenizer(model_name="openai/gpt-4"):
    if model_name.startswith("openai") or model_name.startswith('anthropic') or model_name.startswith('googleai') or model_name.startswith('meta'):
        return tiktoken.encoding_for_model('gpt-4o-2024-08-06')#model_name.split("/")[-1])
    else:
